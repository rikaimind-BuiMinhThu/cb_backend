class CreateInstagramAccounts < ActiveRecord::Migration[7.0]
  def change
    create_table :instagram_accounts do |t|
      ...
      t.integer :post_comment_bag_status, null: false, default: 0
      t.integer :story_comment_bag_id
      t.integer :story_comment_bag_status, null: false, default: 0
      t.integer :live_comment_bag_id
      t.integer :live_comment_bag_status, null: false, default: 0
