class Chatbot < ApplicationRecord
  ...
  mount_base64_uploader :avatar_pc, ChatbotIconUploader
  mount_base64_uploader :avatar_mobile, ChatbotIconUploader
  mount_base64_uploader :avatar_on_open, ChatbotIconUploader
