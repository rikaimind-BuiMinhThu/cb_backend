class Api::V1::MessageManagements::IceBreakersController < ApplicationController
  ...
  def status
    instagram_ice_breakers = HttpManager.new("https://graph.facebook.com/v11.0/me/messenger_profile?fields=ice_breakers&platform=instagram&access_token=#{Settings.webhook.page_instagram_access_token}")
      .get_request
